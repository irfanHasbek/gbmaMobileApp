        ...
        tx.executeSql("SELECT*FROM urunler where _id=" + id, [],
            function(tx,  results) {
                ...
                for (var i = 0; i < icerik.length; i++) {
                    var urun = $('<tr><td ><span style="color:#fff">' + icerik[i].dosyaAdi +'</span></td><td><a href="http://docs.google.com/viewer?url='+icerik[i].dosyaLinki+'" style="color:#fff;"><img style="width:20px" src="images/pdf.png"  alt=""></a></td></tr>');
                    $(".tblUrun").append(urun);
                }
            });
    });
