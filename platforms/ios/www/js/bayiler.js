    ...
    database.transaction(function(tx)
    {
            ...
            results)
        {
            ...
            for (var i = 0; i < len; i++)
            {
                ...
                var listData = $('<p><strong>' + item.isimSoyisim + '</strong></p><p><span>Bölge Adi: ' + item.bolgeAdi + '</span></p><p><span >-E-mail: ' + item.email +'</span></p><p><span>-Telefon1 :0' + item.telefon1 + '</span></p><p><span>-Telefon2 :0' + item.telefon2 + '</span></p><p><span>-GSM :0' + item.gsm + '</span></p><p><span>-Fax :0' + item.fax +'</span></p><p><span>-adres :' + item.adres + '</span></p><br>');
