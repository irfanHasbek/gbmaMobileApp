    ...
    database.transaction(function(tx)
    {
            ...
            results)
        {
            ...
            for (var i = 0; i < len; i++)
            {
                ...
                var listData = $('<p><strong>' + item.bayiAdi + '</strong></p><p><span >-E-mail: ' + item.email +
                    '</span></p><p><span>-Telefon1 :' + item.telefon1 + '</span></p><p><span>-Telefon2 :' + item.telefon2 + '</span></p><p><span>-GSM :' + item.gsm + '</span></p><p><span>-Fax :' + item.fax +'</span></p><p><span>-adres :' + item.adres + '</span></p><br>');
