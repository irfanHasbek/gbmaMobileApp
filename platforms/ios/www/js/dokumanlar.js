        ...
        tx.executeSql("SELECT*FROM dokumanlar", [], function(tx,
            ...
            for (var i = 0; i < len; i++) {
                ...
                for (var j = 0; j < icerik.length; j++) {
                    var dokuman = $('<tr><td style="color:#fff">' +icerik[j].dosyaAdi +'</td><td><a href="pdfGoruntule.html?src=' + icerik[j].dosyaLinki +'&sayfa='+sayfa+'"><img src="images/pdf.png" style="width:22px" alt=""></a></td></tr>');
